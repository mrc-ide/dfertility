...

{
  ...
  DATA_MATRIX(X_tips_dummy_7);
  DATA_MATRIX(X_tips_dummy_8);
...
//
  ...
  vector<Type> mu_obs_pred_dhs(X_extract_dhs * (M_full_obs * log(lambda_out))
                                ...
                                + X_tips_dummy_7 * beta_tips_dummy_6 * Type(0.66)          // TIPS fixed effect
                                + X_tips_dummy_8 * beta_tips_dummy_6 * Type (0.33)          // TIPS fixed effect
